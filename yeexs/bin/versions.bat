@echo off
rem /**
rem  * Copyright &copy; 2012-2016 <a href="https://github.com/yee/yide">yide</a> All rights reserved.
rem  *
...
rem �滻 yide.properties �еİ汾��
echo.
set f=%cd%\src\main\resources\yide.properties
echo [INFO] Update %f%
set s1=version=

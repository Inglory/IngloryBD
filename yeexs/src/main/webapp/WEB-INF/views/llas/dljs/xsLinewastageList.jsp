...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/dljs/xsLinewastage/">计算结果查询</a></li>
		<shiro:hasPermission name="dljs:xsLinewastage:edit"><li><a href="${ctx}/dljs/xsLinewastage/form">电量手工调整</a></li></shiro:hasPermission>
</ul>
	<form:form id="searchForm" modelAttribute="xsLinewastage" action="${ctx}/dljs/xsLinewastage/" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li class="btns"><a class="btn btn-primary" href="${ctx}/dljs/xsLinewastage/jisuan">电量计算</a></li>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>最终得分</th>
				<th>其他得分</th>
				<shiro:hasPermission name="dljs:xsLinewastage:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="xsLinewastage">
			<tr>
				<td><a href="${ctx}/dljs/xsLinewastage/form?id=${xsLinewastage.id}">
				...
				<shiro:hasPermission name="dljs:xsLinewastage:edit"><td>
    				<a href="${ctx}/dljs/xsLinewastage/form?id=${xsLinewastage.id}">修改</a>
					<a href="${ctx}/dljs/xsLinewastage/delete?id=${xsLinewastage.id}" onclick="return confirmx('确认要删除该电量计算吗？', this.href)">删除</a>

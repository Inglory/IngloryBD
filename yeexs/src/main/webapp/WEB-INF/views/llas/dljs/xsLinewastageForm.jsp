...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/dljs/xsLinewastage/">计算结果查询</a></li>
		<li class="active"><a href="${ctx}/dljs/xsLinewastage/form?id=${xsLinewastage.id}">电量手工调整<shiro:hasPermission name="dljs:xsLinewastage:edit">${not empty xsLinewastage.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="dljs:xsLinewastage:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="xsLinewastage" action="${ctx}/dljs/xsLinewastage/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">线路：</label>
			<div class="controls">
				<form:input path="lineId" htmlEscape="false" maxlength="64" class="input-xlarge required" readonly="readonly"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">线路编号：</label>
			<div class="controls">
				<form:input path="lineCode" htmlEscape="false" maxlength="64" class="input-xlarge " readonly="readonly"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">线路名称：</label>
			<div class="controls">
				<form:input path="linename" htmlEscape="false" maxlength="200" class="input-xlarge " readonly="readonly"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label">copyerror：</label>
			<div class="controls">
		...
		<div class="form-actions">
			<shiro:hasPermission name="dljs:xsLinewastage:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>

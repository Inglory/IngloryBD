...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/tjgx/xsRelationAll/">全网综合统计关系列表</a></li>
		<li class="active"><a href="${ctx}/tjgx/xsRelationAll/form?id=${xsRelationAll.id}">全网综合统计关系<shiro:hasPermission name="tjgx:xsRelationAll:edit">${not empty xsRelationAll.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="tjgx:xsRelationAll:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="xsRelationAll" action="${ctx}/tjgx/xsRelationAll/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">统计项目：</label>
			<div class="controls">
		...
		<div class="form-actions">
			<shiro:hasPermission name="tjgx:xsRelationAll:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>

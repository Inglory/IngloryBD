...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/tjgx/xsGxZb/">主变关系列表</a></li>
		<li class="active"><a href="${ctx}/tjgx/xsGxZb/form?id=${xsGxZb.id}">主变关系<shiro:hasPermission name="tjgx:xsGxZb:edit">${not empty xsGxZb.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="tjgx:xsGxZb:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="xsGxZb" action="${ctx}/tjgx/xsGxZb/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="tjgx:xsGxZb:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>

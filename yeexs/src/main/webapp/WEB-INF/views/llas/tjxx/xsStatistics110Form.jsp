...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/tjxx/xsStatistics110/">110kV线损统计结果信息列表</a></li>
		<li class="active"><a href="${ctx}/tjxx/xsStatistics110/form?id=${xsStatistics110.id}">110kV线损统计结果信息<shiro:hasPermission name="tjxx:xsStatistics110:edit">${not empty xsStatistics110.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="tjxx:xsStatistics110:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="xsStatistics110" action="${ctx}/tjxx/xsStatistics110/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="tjxx:xsStatistics110:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>

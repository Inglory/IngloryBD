...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/tjxx/xsBdzdlss/">变电站电量损失列表</a></li>
		<li class="active"><a href="${ctx}/tjxx/xsBdzdlss/form?id=${xsBdzdlss.id}">变电站电量损失<shiro:hasPermission name="tjxx:xsBdzdlss:edit">${not empty xsBdzdlss.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="tjxx:xsBdzdlss:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="xsBdzdlss" action="${ctx}/tjxx/xsBdzdlss/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="bdzid" class="input-xlarge ">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="bdzbh" htmlEscape="false" maxlength="64" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">变电站名称：</label>
			<div class="controls">
				<form:input path="bdzmc" htmlEscape="false" maxlength="100" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="tjxx:xsBdzdlss:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>

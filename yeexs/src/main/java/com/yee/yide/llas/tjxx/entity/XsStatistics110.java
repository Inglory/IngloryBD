 ...
 * @version 2017-04-19
 */
public class XsStatistics110 extends DataEntity<XsStatistics110> {
	...
	public XsStatistics110() {
		super();
	}

	public XsStatistics110(String id){
		super(id);
	}
	...
	@Length(min=0, max=64, message="线路长度必须介于 0 和 64 之间")
